...
async def logosq(bot, message):
    ...
    try:
      ...
      await message.reply_photo(logo,caption = "**🖼 Logo Generated By {bot}**",reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Upload As File 📁", callback_data=f"flogo {logo_id}")]]))
      await x.delete()
    except FloodWait:
      pass
