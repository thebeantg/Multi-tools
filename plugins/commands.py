...
async def logo(bot, message):
  ...
  try:
    ...
    await message.reply_photo(logo,caption=f"**🖼 Logo Generated By {bot.mention)**",reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Upload As File 📁", callback_data=f"flogo {logo_id}")]]))
    await x.delete()
  except FloodWait:
    pass
  except Exception as e:
