...
PICS = os.environ.get("PICS", "https://telegra.ph/file/a6e30f36d05317d87bbc1.jpg").split()

ADMIN = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5104213780').split()]
